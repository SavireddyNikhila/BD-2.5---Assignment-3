...
function sortHotelsByPricingInAscendingOrder(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}

function sortHotelsByPricingInDescendingOrder(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing === 'low-to-high') {
    sortedHotels = hotelsCopy.sort(sortHotelsByPricingInAscendingOrder);
  } else if (pricing === 'high-to-low') {
    sortedHotels = hotelsCopy.sort(sortHotelsByPricingInDescendingOrder);
  }
  res.json({ hotels: sortedHotels });
});

function sortHotelsByRatingInAscendingOrder(hotel1, hotel2) {
  return hotel1.rating - hotel2.rating;
}

function sortHotelsByRatingInDescendingOrder(hotel1, hotel2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating === 'low-to-high') {
    sortedHotels = hotelsCopy.sort(sortHotelsByRatingInAscendingOrder);
  } else if (rating === 'high-to-low') {
    sortedHotels = hotelsCopy.sort(sortHotelsByRatingInDescendingOrder);
  }
  res.json({ hotels: sortedHotels });
});

function sortHotelsByReviewsInAscendingOrder(hotel1, hotel2) {
  return hotel1.reviews - hotel2.reviews;
}

function sortHotelsByReviewsInDescendingOrder(hotel1, hotel2) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews === 'least-to-most') {
    sortedHotels = hotelsCopy.sort(sortHotelsByReviewsInAscendingOrder);
  } else if (reviews === 'most-to-least') {
    sortedHotels = hotelsCopy.sort(sortHotelsByReviewsInDescendingOrder);
  }
  res.json({ hotels: sortedHotels });
});
